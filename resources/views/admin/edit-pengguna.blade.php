...
<div class="container">
  <div class="form-container">
    <form action="{{ route('edit', $user->id) }}" method="POST" id="my-form">
      @csrf
      ...
      <div class="form-footer">
        ...
        <button type="button" class="form-btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Simpan</button>
      </div>
    </form>
  </div>
</div>
